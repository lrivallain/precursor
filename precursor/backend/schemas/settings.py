...
class SettingsPayload(BaseModel):
    ...
    # Azure AI Speech region for the speech-to-text composer (key goes via
    # api_keys as `azure_speech_key`).
...
class SettingsRead(BaseModel):
    ...
    # Azure AI Speech: configured region (never echoes the key) + a readiness
    # flag the composer uses to choose the STT provider.
