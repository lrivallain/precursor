      ...
      "/features/": [
        {
          ...
          items: [
            ...
            },
            {
              ...
              collapsed: true,
              items: [
                { text: "Building a pipeline", link: "/features/workflows/building" },
                { text: "Configuring a step", link: "/features/workflows/steps" },
                { text: "Running a pipeline", link: "/features/workflows/running" },
                { text: "Reference", link: "/features/workflows/reference" },
                { text: "Authoring spec (for AI agents)", link: "/reference/workflow-authoring" },
              ],
            },
      ...
      "/reference/": [
        {
          ...
          items: [
            ...
            { text: "Workflow authoring spec", link: "/reference/workflow-authoring" },
