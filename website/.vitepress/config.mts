...
export default defineConfig({
  ...
  title: "Precursor",
  description:
    "Opinionated AI assistant chat for work follow-up — topics linked to GitHub issues, live meetings, autonomous agents, MCP, and more, in a single local-first app.",
  cleanUrls: true,
  lastUpdated: true,
  ...
  head: [
    ...
    [
      "meta",
      {
        ...
        content:
          "Opinionated AI assistant chat for work follow-up — topics linked to the GitHub issues they belong to, in a single local-first app.",
      },
    ],
  ],
