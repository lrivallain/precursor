...
export default defineConfig({
  ...
  title: "Precursor",
  description:
    "Per-topic AI chat interface for work follow-up — topics, chats, live meetings, autonomous agents, MCP, and more, in a single local-first app.",
  cleanUrls: true,
  lastUpdated: true,
  ...
  head: [
    ...
    [
      "meta",
      {
        ...
        content:
          "A single, local-first app for tracking work-in-progress conversations alongside the GitHub issues they belong to.",
      },
    ],
  ],
